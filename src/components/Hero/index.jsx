    ...
    <div className="hero">
      <div className="wrapper">
        <motion.div
          ...
          animate="animate"
        >
          <motion.h2 variants={textVarients}>ARVIND DEV</motion.h2>
          <motion.h1 variants={textVarients}>
            Web Developer and MERN STACK Developer
          </motion.h1>
          <motion.div className="buttons" variants={textVarients}>
            <motion.button variants={textVarients}>
              See the latest work
            </motion.button>
            <motion.button variants={textVarients}>Conatct Me</motion.button>
          </motion.div>
          <motion.img
